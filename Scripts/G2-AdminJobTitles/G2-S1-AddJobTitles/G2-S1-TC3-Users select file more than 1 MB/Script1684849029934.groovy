...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddJobTitle/Page_OrangeHRM/span_Attachment Size Exceeded'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddJobTitle/Page_OrangeHRM/span_Attachment Size Exceeded'), GlobalVariable.promptAttachmentSizeExceeded)
