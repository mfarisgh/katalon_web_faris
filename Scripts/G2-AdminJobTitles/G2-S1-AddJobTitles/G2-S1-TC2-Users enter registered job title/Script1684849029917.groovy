...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddJobTitle/Page_OrangeHRM/span_JobTitle_Already exists'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddJobTitle/Page_OrangeHRM/span_JobTitle_Already exists'), GlobalVariable.promptAlreadyExists)
