...
'Parameterized jobTitle to select based on specified job title'
WebUI.check(findTestObject('OrangeHRM-DeleteJobTitle/Page_OrangeHRM/div_Job_Checkbox_oxd-table-cell oxd-padding-cell', [
            ('jobTitle') : jobTitle]))

'Parameterized jobTitle to select based on specified job title'
WebUI.click(findTestObject('OrangeHRM-DeleteJobTitle/Page_OrangeHRM/button_Job_Delete_oxd-icon-button oxd-table-cell-action-space', 
        [('jobTitle') : jobTitle]))
...
'Verify whether table has no longer the deleted job title'
