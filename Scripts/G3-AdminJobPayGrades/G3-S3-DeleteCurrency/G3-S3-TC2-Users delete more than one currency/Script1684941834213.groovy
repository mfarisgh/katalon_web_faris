...
'Call function that consists of test steps based in G3-S3-TC1 but run multple times based on number of currencies'
CustomKeywords.'payGrade.deleteCurrency.deleteMultipleCurrency'(currencies)
...
WebUI.click(findTestObject('OrangeHRM-DeleteCurrency/Page_OrangeHRM/button_Currency_Multiple_Delete Selected'))
...
'Verify whether table no longer contains deleted currencies'
CustomKeywords.'payGrade.deleteCurrency.verifyDeleteMultipleCurrency'(currencies)
