...
WebUI.sendKeys(findTestObject('OrangeHRM-EditCurrency/Page_OrangeHRM/input_Currency_Maximum Salary_oxd-input oxd-input--focus'), 
    Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('OrangeHRM-EditCurrency/Page_OrangeHRM/input_Currency_Maximum Salary_oxd-input oxd-input--focus'), 
    Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('OrangeHRM-EditCurrency/Page_OrangeHRM/input_Currency_Maximum Salary_oxd-input oxd-input--focus'), 
    maxSalary)
...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-EditCurrency/Page_OrangeHRM/p_Currency_Prompt_Successfully Updated'), 
    0)

WebUI.verifyElementText(findTestObject('OrangeHRM-EditCurrency/Page_OrangeHRM/p_Currency_Prompt_Successfully Updated'), 
    GlobalVariable.promptUpdateSuccess)
