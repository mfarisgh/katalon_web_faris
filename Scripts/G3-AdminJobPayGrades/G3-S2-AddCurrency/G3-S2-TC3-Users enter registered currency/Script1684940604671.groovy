...
WebUI.verifyElementNotPresent(findTestObject('OrangeHRM-AddCurrency/Page_OrangeHRM/span_Currency_DropdownValue', [('currency') : currency]), 
    0)
...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddCurrency/Page_OrangeHRM/span_Currency_Prompt_Required'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddCurrency/Page_OrangeHRM/span_Currency_Prompt_Required'), GlobalVariable.promptRequired)
