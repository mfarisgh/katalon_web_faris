...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddCurrency/Page_OrangeHRM/p_Currency_Prompt_Successfully Saved'), 
    0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddCurrency/Page_OrangeHRM/p_Currency_Prompt_Successfully Saved'), GlobalVariable.promptSavedSuccess)
