...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddPayGrade/Page_OrangeHRM/span_PayGrade_Prompt_Already exists'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddPayGrade/Page_OrangeHRM/span_PayGrade_Prompt_Already exists'), GlobalVariable.promptAlreadyExists)
