...
'Call function that consists of test steps based in G4-S2-TC1 but run multple times based on number of employment status'
CustomKeywords.'employmentStatus.deleteEmploymentStatus.deleteMultipleEmploymentStatus'(employmentStatusNames)
...
WebUI.click(findTestObject('OrangeHRM-DeleteEmploymentStatus/Page_OrangeHRM/button_EmpStatus_Multiple_Delete Selected'))
...
CustomKeywords.'employmentStatus.deleteEmploymentStatus.verifyDeleteMultipleEmploymentStatus'(employmentStatusNames)
