...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddSkill/Page_OrangeHRM/span_Skill_Prompt_Already exists'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddSkill/Page_OrangeHRM/span_Skill_Prompt_Already exists'), GlobalVariable.promptAlreadyExists)
