...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-EditSkill/Page_OrangeHRM/span_Skill_Prompt_Already exists'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-EditSkill/Page_OrangeHRM/span_Skill_Prompt_Already exists'), GlobalVariable.promptAlreadyExists)
