...
WebUI.setEncryptedText(findTestObject('OrangeHRM-UsersManagement/Page_OrangeHRM/input_Password_oxd-input oxd-input--focus'), 
    encryptedPass)

WebUI.waitForPageLoad(0)

WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Prompt_Your password must contain minimum 1 number'), 
    0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Prompt_Your password must contain minimum 1 number'), 
    GlobalVariable.promptPasswordNotAlphanumeric)
