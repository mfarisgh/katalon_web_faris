...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Username_PromptLessThanFive'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Username_PromptLessThanFive'), GlobalVariable.promptLessThanFiveChars)
