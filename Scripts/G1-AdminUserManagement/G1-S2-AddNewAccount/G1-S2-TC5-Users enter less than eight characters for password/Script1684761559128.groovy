...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Password_PromptLessThanSevenChars'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Password_PromptLessThanSevenChars'), GlobalVariable.promptLessThanSevenChars)
