...
WebUI.setEncryptedText(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/input_Password_oxd-input oxd-input--focus'), pass)
...
WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Prompt_Required'), 0)

WebUI.verifyElementText(findTestObject('OrangeHRM-AddUser/Page_OrangeHRM/span_Prompt_Required'), GlobalVariable.promptRequired)
