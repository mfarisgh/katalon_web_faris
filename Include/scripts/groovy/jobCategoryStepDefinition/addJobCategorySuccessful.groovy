...
class addJobCategorySuccessful {
	/**
	...
	@Then("Job Category (.*) is successfully saved")
	def jobCategorySaved(String jobCategoryName) {
		WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddJobCategory/Page_OrangeHRM/p_JobCategory_Prompt_Successfully Saved'),
				0)

		WebUI.verifyElementText(findTestObject('OrangeHRM-AddJobCategory/Page_OrangeHRM/p_JobCategory_Prompt_Successfully Saved'),
		...
		WebUI.waitForElementVisible(findTestObject('OrangeHRM-AddJobCategory/Page_OrangeHRM/div_JobCategory_Name_List', [('jobCategoryName') : jobCategoryName]),
		0)

		WebUI.verifyElementPresent(findTestObject('OrangeHRM-AddJobCategory/Page_OrangeHRM/div_JobCategory_Name_List', [('jobCategoryName') : jobCategoryName]),
		0)

		WebUI.verifyElementText(findTestObject('OrangeHRM-AddJobCategory/Page_OrangeHRM/div_JobCategory_Name_List', [('jobCategoryName') : jobCategoryName]),
		jobCategoryName)
